...
var SNAKE_SPEED = 20 // cells per second
...
export default {
  ...
  data () {
    return {
      ...
      gridDimensions: [50, 50], // odd values may result in a blurry grid (because of transform(-50%, -50%))
      snake: [
        [1, 0],
        [1, 1]
      ],
  ...
  methods: {
    ...
    submitScore () {
	  ...
	  /*scoreboard.remove(function(error){});*/
